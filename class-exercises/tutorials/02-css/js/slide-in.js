//Ensure JS runs after HMTL  content is loaded
document.addEventListener("DOMContentLoaded", function () {
    // Grab all the elements with class project-item
    const projectItems = document.querySelectorAll(".project-item");

    //Applies slide-in class to objects when they're visible to make them animate
    function checkSlide() {
        ...
        projectItems.forEach((projectItem) => {
            ...
            //Check if the element is halfway shown or scrolled past
    ...
    //Runs the checkSlide function on a page scroll or window resize
